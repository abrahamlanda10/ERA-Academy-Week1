...
// POST / students- receive new student data and inserts it into MySQL
app.post("/students", (req, res) => {
    ...
    if (!first_name || !last_name || !grade_level) {
        return res.status(400).json({ error: "First Name, Last Name and Grade required" });
    }
...
//POST/users-creste a new user account
...
//POST /login-checks emails and password against the users table
...
//GET /students/id/attendance - return attendance for one student
